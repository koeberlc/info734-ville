...
const connectDb = async () => {
    await mongoose.connect('mongodb+srv://user:&E[<{V9WbC@cluster0.kfkxu.mongodb.net/info734-ville?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology : true}).then(
        () => {
